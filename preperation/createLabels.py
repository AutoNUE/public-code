...
def process_folder(fn):
    ...
    if args.instance:
        dst = fn.replace("_polygons.json", "_instance{}s.png".format(args.id_type))
...
def main(args):
    if not args.panoptic:
        ...
        for split in ['train', 'val']:
            ...
            panoptic_converter(args.num_workers, os.path.join(folder_name, split), output_folder, out_file)
